    ...
    <div class="wrapper">
      ...
      <div class="grid">
        <div class="item">
          ...
          <p>
            It’s more than just a logo, font, and colours! Without strong
            branding that lays the foundation for your marketing activities,
            you'll just be more white noise to the average consumer.
          </p>
        </div>
        <div class="item">
